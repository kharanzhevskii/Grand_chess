...
sf::Texture PieceTextures::blackChancellor = PieceTextures::loadTexture("Textures/b_chancellor.png");
sf::Texture PieceTextures::blackArchbishop = PieceTextures::loadTexture("Textures/b_archbishop.png");
...
sf::Texture PieceTextures::whiteChancellor = PieceTextures::loadTexture("Textures/w_chancellor.png");
sf::Texture PieceTextures::whiteArchbishop = PieceTextures::loadTexture("Textures/w_archbishop.png");
